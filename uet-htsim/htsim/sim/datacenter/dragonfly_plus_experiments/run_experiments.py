...
ht_exps = {
    "full_permutation": [
        ...
        "--K 4 --HT_TYPE standard --CNT_RUNS_PER_TOPO 10 --DO_CC no_cc_pfc", # (uncomment)
        ...
        # "--K 6 --HT_TYPE standard --CNT_RUNS_PER_TOPO 10 --DO_CC no_cc_pfc", # (uncomment)
        ...
        # "--K 8 --HT_TYPE standard --CNT_RUNS_PER_TOPO 10 --DO_CC no_cc_pfc", # (uncomment)
    ],
    "partial_all_to_all": [
        "--K 6",
